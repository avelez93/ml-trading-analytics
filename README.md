# Algorithmic Trading System: End-to-End ML Pipeline &amp; Performance Analytics
...
### 📌 Project Overview
This repository serves as the public performance interface for an **End-to-End Algorithmic Trading System**. 

The core engine is a production-ready pipeline that handles the full lifecycle of financial data: from ingestion and automated cleaning to model training, validation, and real-time execution. The system is designed to identify and exploit short-to-medium term market inefficiencies using Machine Learning.
...
* **Database:** High-availability data persistence using **MongoDB**.
* **CI/CD:** Automated testing and deployment cycles via **GitLab CI/CD**.

### 📊 Performance & Analytics
The system's performance is audited through an interactive dashboard that tracks:
* **Account ROI (%):** Time-weighted returns considering dynamic capital injections.
